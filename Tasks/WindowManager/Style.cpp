...
void WindowManager::SetupLVGLStyles()
{
	...
	ThemeManager::AddColour(ColourAttribute::ContainerBackgroundColour, ThemeManager::GetColour(ColourAttribute::WindowBackground));
	...
	ThemeManager::AddFont(FontAttribute::Window,
			FontManager::GetFontByNameStyleAndSize("IBM Plex Sans", "Regular", ThemeManager::GetConst(ConstAttribute::WindowFontSize)));
	ThemeManager::AddFont(FontAttribute::WindowBold,
			FontManager::GetFontByNameStyleAndSize("IBM Plex Sans", "Bold", ThemeManager::GetConst(ConstAttribute::WindowFontSize)));
	ThemeManager::AddFont(FontAttribute::Body,
			FontManager::GetFontByNameStyleAndSize("IBM Plex Sans", "Regular", ThemeManager::GetConst(ConstAttribute::BodyFontSize)));
	ThemeManager::AddFont(FontAttribute::BodyBold,
			FontManager::GetFontByNameStyleAndSize("IBM Plex Sans", "Bold", ThemeManager::GetConst(ConstAttribute::BodyFontSize)));
	ThemeManager::AddFont(FontAttribute::Header,
			FontManager::GetFontByNameStyleAndSize("IBM Plex Sans", "Bold", ThemeManager::GetConst(ConstAttribute::HeaderFontSize)));
...
/*	{
	...
	}*/
	{
		...
		lv_style_set_radius(style, 0);
		lv_style_set_border_width(style, 0);
		lv_style_set_bg_color(style, lv_color_mix(ThemeManager::GetColour(ColourAttribute::ControlHighlightColour), lv_color_hex(0x00FF000), 192));
	...
	}
	{
		...
		lv_style_set_radius(style, 0);
		lv_style_set_border_width(style, 0);
		lv_style_set_bg_color(style, lv_color_mix(ThemeManager::GetColour(ColourAttribute::ControlHighlightColour), lv_color_hex(0xFF00000), 192));
