...
const lv_color_t CONTAINER_BACKGROUND_COLOUR = lv_color_hex(0xb0b0b0);
const lv_color_t CONTROL_BORDER_COLOUR = lv_color_hex(0xC0C0C0);
...
void SetupLVGLStyles() {
    ...
    lv_style_set_text_font(&style_window_content, &plex_sans_16);
    ...
    lv_style_set_pad_all(&style_grid, 2);
