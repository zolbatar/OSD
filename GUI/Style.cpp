...
const lv_color_t WINDOW_BACKGROUND_COLOUR = lv_color_hex(0x909090);
...
void SetupLVGLStyles()
{
	...
	lv_style_set_pad_right(&style_window_content, 0);
	lv_style_set_pad_bottom(&style_window_content, 0);
	...
	lv_style_set_pad_all(&style_window_header, 5);
