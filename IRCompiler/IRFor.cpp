...
void IRCompiler::CompileTokenFor(Token *token) {
    if (token->vtype.IsInteger()) {
        ...
        AddIRWithIndex(IROpcodes::VariableStoreInteger, token->index + 1);
        ...
        if (token->expressions.size() == 3) {
            ...
            EnsureStackIsInteger(token, type);
            AddIR(IROpcodes::StackPopIntOperand1);
            AddIRWithIndex(IROpcodes::VariableStoreInteger, token->index + 2);

            // Adjust iterations
            AddIRWithIndex(IROpcodes::VariableLoadInteger, token->index + 2);
            AddIR(IROpcodes::StackPushIntOperand1);
            AddIRWithIndex(IROpcodes::VariableLoadInteger, token->index + 1);
            AddIR(IROpcodes::StackPushIntOperand1);
            AddIR(IROpcodes::StackPopIntOperand2);
            AddIR(IROpcodes::StackPopIntOperand1);
        ...
        if (token->expressions.size() == 3) {
            ...
            EnsureStackIsFloat(token, type);
            AddIR(IROpcodes::StackPopFloatOperand1);
            AddIRWithIndex(IROpcodes::VariableStoreFloat, token->index + 2);

            // Adjust iterations
            AddIRWithIndex(IROpcodes::VariableLoadFloat, token->index + 2);
            AddIR(IROpcodes::StackPushFloatOperand1);
            AddIRWithIndex(IROpcodes::VariableLoadFloat, token->index + 1);
            AddIR(IROpcodes::StackPushFloatOperand1);
            AddIR(IROpcodes::StackPopFloatOperand2);
            AddIR(IROpcodes::StackPopFloatOperand1);
            AddIR(IROpcodes::MathsDivide);
            AddIRWithIndex(IROpcodes::VariableStoreFloat, token->index + 1);
        } else {
