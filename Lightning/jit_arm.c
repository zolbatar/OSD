...
#define arg_base() (stack_framesize - 16 + (jit_cpu.abi ? 64 : 0))
#define arg_offset(n) ((n) < 4 ? arg_base() + ((n) << 2) : (n))
...
void _jit_init(jit_state_t *_jit)
{
    jit_int32_t regno;
...
void _jit_prolog(jit_state_t *_jit)
{
    jit_int32_t offset;
    ...
    {
        jit_realloc((jit_pointer_t *)&_jitc->functions.ptr, _jitc->functions.length * sizeof(jit_function_t),
    ...
    _jitc->function->self.argi = _jitc->function->self.argf = _jitc->function->self.alen = 0;
    if (jit_swf_p())
    ...
    jit_alloc((jit_pointer_t *)&_jitc->function->regoff, _jitc->reglen * sizeof(jit_int32_t));
...
jit_int32_t _jit_allocai(jit_state_t *_jit, jit_int32_t length)
{
...
void _jit_allocar(jit_state_t *_jit, jit_int32_t u, jit_int32_t v)
{
    jit_int32_t reg;
    assert(_jitc->function);
...
void _jit_ret(jit_state_t *_jit)
{
    jit_node_t *instr;
    assert(_jitc->function);
    jit_inc_synth(ret);
...
void _jit_retr(jit_state_t *_jit, jit_int32_t u)
{
...
void _jit_reti(jit_state_t *_jit, jit_word_t u)
{
...
void _jit_retr_f(jit_state_t *_jit, jit_int32_t u)
{
...
void _jit_reti_f(jit_state_t *_jit, jit_float32_t u)
{
...
void _jit_retr_d(jit_state_t *_jit, jit_int32_t u)
{
...
void _jit_reti_d(jit_state_t *_jit, jit_float64_t u)
{
...
void _jit_epilog(jit_state_t *_jit)
{
    assert(_jitc->function);
...
jit_bool_t _jit_arg_register_p(jit_state_t *_jit, jit_node_t *u)
{
...
static jit_node_t *_jit_make_arg(jit_state_t *_jit, jit_node_t *node)
{
    jit_int32_t offset;
...
jit_node_t *_jit_make_arg_f(jit_state_t *_jit, jit_node_t *node)
{
    jit_int32_t offset;
...
jit_node_t *_jit_make_arg_d(jit_state_t *_jit, jit_node_t *node)
{
    jit_int32_t offset;
    if (jit_cpu.abi && !(_jitc->function->self.call & jit_call_varargs))
    {
...
void _jit_va_push(jit_state_t *_jit, jit_int32_t u)
{
...
jit_node_t *_jit_arg(jit_state_t *_jit)
{
    assert(_jitc->function);
    return (jit_make_arg((jit_node_t *)0));
}

jit_node_t *_jit_arg_f(jit_state_t *_jit)
{
    assert(_jitc->function);
    return (jit_make_arg_f((jit_node_t *)0));
}

jit_node_t *_jit_arg_d(jit_state_t *_jit)
{
    assert(_jitc->function);
    return (jit_make_arg_d((jit_node_t *)0));
}

void _jit_getarg_c(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
...
void _jit_getarg_uc(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_getarg_s(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_getarg_us(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_getarg_i(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_putargr(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_putargi(jit_state_t *_jit, jit_word_t u, jit_node_t *v)
{
    jit_int32_t regno;
    assert(v->code == jit_code_arg);
...
void _jit_getarg_f(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
...
void _jit_putargr_f(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg_f);
...
void _jit_putargi_f(jit_state_t *_jit, jit_float32_t u, jit_node_t *v)
{
    jit_int32_t regno;
    assert(v->code == jit_code_arg_f);
...
void _jit_getarg_d(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
...
void _jit_putargr_d(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg_d);
...
void _jit_putargi_d(jit_state_t *_jit, jit_float64_t u, jit_node_t *v)
{
    jit_int32_t regno;
    assert(v->code == jit_code_arg_d);
...
void _jit_pushargr(jit_state_t *_jit, jit_int32_t u)
{
    assert(_jitc->function);
...
void _jit_pushargi(jit_state_t *_jit, jit_word_t u)
{
    jit_int32_t regno;
    assert(_jitc->function);
...
void _jit_pushargr_f(jit_state_t *_jit, jit_int32_t u)
{
    assert(_jitc->function);
...
void _jit_pushargi_f(jit_state_t *_jit, jit_float32_t u)
{
    jit_int32_t regno;
    assert(_jitc->function);
...
void _jit_pushargr_d(jit_state_t *_jit, jit_int32_t u)
{
    assert(_jitc->function);
    ...
    else
    {
        ...
        if (jit_arg_reg_p(_jitc->function->call.argi))
        {
            jit_movr_d_ww(JIT_RA0 - _jitc->function->call.argi, JIT_RA0 - (_jitc->function->call.argi + 1), u);
...
void _jit_pushargi_d(jit_state_t *_jit, jit_float64_t u)
{
    jit_int32_t regno;
    assert(_jitc->function);
    ...
    else
    {
        ...
        if (jit_arg_reg_p(_jitc->function->call.argi))
        {
            jit_movi_d_ww(JIT_RA0 - _jitc->function->call.argi, JIT_RA0 - (_jitc->function->call.argi + 1), u);
            _jitc->function->call.argi += 2;
            goto done;
        }
    }
...
jit_bool_t _jit_regarg_p(jit_state_t *_jit, jit_node_t *node, jit_int32_t regno)
{
    jit_int32_t spec;
...
void _jit_finishr(jit_state_t *_jit, jit_int32_t r0)
{
    jit_node_t *node;
    assert(_jitc->function);
...
jit_node_t *_jit_finishi(jit_state_t *_jit, jit_pointer_t i0)
{
    jit_node_t *node;
    assert(_jitc->function);
...
void _jit_retval_c(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_uc(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_s(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_us(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_i(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_f(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_d(jit_state_t *_jit, jit_int32_t r0)
{
...
jit_pointer_t _emit_code(jit_state_t *_jit)
{
    jit_node_t *node;
    jit_node_t *temp;
    jit_word_t word;
...
#define case_rrr(name, type)                                                                                           \
    case jit_code_##name##r##type:                                                                                     \
        name##r##type(rn(node->u.w), rn(node->v.w), rn(node->w.w));                                                    \
        break
#define case_rrrr(name, type)                                                                                          \
    case jit_code_##name##r##type:                                                                                     \
        name##r##type(rn(node->u.q.l), rn(node->u.q.h), rn(node->v.w), rn(node->w.w));                                 \
        break
#define case_vvv(name, type)                                                                                           \
    case jit_code_##name##r##type:                                                                                     \
        if (jit_swf_p())                                                                                               \
            swf_##name##r##type(rn(node->u.w), rn(node->v.w), rn(node->w.w));                                          \
        else                                                                                                           \
            vfp_##name##r##type(rn(node->u.w), rn(node->v.w), rn(node->w.w));                                          \
        break
...
#define case_rrrw(name, type)                                                                                          \
    case jit_code_##name##i##type:                                                                                     \
        name##i##type(rn(node->u.q.l), rn(node->u.q.h), rn(node->v.w), node->w.w);                                     \
        break
#define case_vvw(name, type)                                                                                           \
    case jit_code_##name##i##type:                                                                                     \
        if (jit_swf_p())                                                                                               \
            swf_##name##i##type(rn(node->u.w), rn(node->v.w), node->w.w);                                              \
        else                                                                                                           \
            vfp_##name##i##type(rn(node->u.w), rn(node->v.w), node->w.w);                                              \
        break
#define case_vvf(name)                                                                                                 \
    case jit_code_##name##i_f:                                                                                         \
        assert_data(node);                                                                                             \
        if (jit_swf_p())                                                                                               \
            swf_##name##i_f(rn(node->u.w), rn(node->v.w), node->w.f);                                                  \
        else                                                                                                           \
            vfp_##name##i_f(rn(node->u.w), rn(node->v.w), node->w.f);                                                  \
        break
#define case_vvd(name)                                                                                                 \
    case jit_code_##name##i_d:                                                                                         \
        assert_data(node);                                                                                             \
        if (jit_swf_p())                                                                                               \
            swf_##name##i_d(rn(node->u.w), rn(node->v.w), node->w.d);                                                  \
        else                                                                                                           \
            vfp_##name##i_d(rn(node->u.w), rn(node->v.w), node->w.d);                                                  \
        break
...
#define case_wvv(name, type)                                                                                           \
    case jit_code_##name##i##type:                                                                                     \
        if (jit_swf_p())                                                                                               \
            swf_##name##i##type(node->u.w, rn(node->v.w), rn(node->w.w));                                              \
        else                                                                                                           \
            vfp_##name##i##type(node->u.w, rn(node->v.w), rn(node->w.w));                                              \
        break
#define case_brr(name, type)                                                                                           \
    case jit_code_##name##r##type:                                                                                     \
        temp = node->u.n;                                                                                              \
        assert(temp->code == jit_code_label || temp->code == jit_code_epilog);                                         \
        if (temp->flag & jit_flag_patch)                                                                               \
            name##r##type(temp->u.w, rn(node->v.w), rn(node->w.w));                                                    \
        else                                                                                                           \
        {                                                                                                              \
            word = name##r##type(_jit->pc.w, rn(node->v.w), rn(node->w.w));                                            \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break
#define case_bvv(name, type)                                                                                           \
    case jit_code_##name##r##type:                                                                                     \
        ...
        {                                                                                                              \
            if (jit_swf_p())                                                                                           \
                swf_##name##r##type(temp->u.w, rn(node->v.w), rn(node->w.w));                                          \
            else                                                                                                       \
                vfp_##name##r##type(temp->u.w, rn(node->v.w), rn(node->w.w));                                          \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
            if (jit_swf_p())                                                                                           \
                word = swf_##name##r##type(_jit->pc.w, rn(node->v.w), rn(node->w.w));                                  \
            else                                                                                                       \
                word = vfp_##name##r##type(_jit->pc.w, rn(node->v.w), rn(node->w.w));                                  \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break
#define case_brw(name, type)                                                                                           \
    case jit_code_##name##i##type:                                                                                     \
        ...
        assert(temp->code == jit_code_label || temp->code == jit_code_epilog);                                         \
        if (temp->flag & jit_flag_patch)                                                                               \
            name##i##type(temp->u.w, rn(node->v.w), node->w.w);                                                        \
        else                                                                                                           \
        {                                                                                                              \
            word = name##i##type(_jit->pc.w, rn(node->v.w), node->w.w);                                                \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break;
#define case_bvf(name)                                                                                                 \
    case jit_code_##name##i_f:                                                                                         \
        ...
        {                                                                                                              \
            if (jit_swf_p())                                                                                           \
                swf_##name##i_f(temp->u.w, rn(node->v.w), node->w.f);                                                  \
            else                                                                                                       \
                vfp_##name##i_f(temp->u.w, rn(node->v.w), node->w.f);                                                  \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
            if (jit_swf_p())                                                                                           \
                word = swf_##name##i_f(_jit->pc.w, rn(node->v.w), node->w.f);                                          \
            else                                                                                                       \
                word = vfp_##name##i_f(_jit->pc.w, rn(node->v.w), node->w.f);                                          \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break
#define case_bvd(name)                                                                                                 \
    case jit_code_##name##i_d:                                                                                         \
        ...
        {                                                                                                              \
            if (jit_swf_p())                                                                                           \
                swf_##name##i_d(temp->u.w, rn(node->v.w), node->w.d);                                                  \
            else                                                                                                       \
                vfp_##name##i_d(temp->u.w, rn(node->v.w), node->w.d);                                                  \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
            if (jit_swf_p())                                                                                           \
                word = swf_##name##i_d(_jit->pc.w, rn(node->v.w), node->w.d);                                          \
            else                                                                                                       \
                word = vfp_##name##i_d(_jit->pc.w, rn(node->v.w), node->w.d);                                          \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break
#if DEVEL_DISASSEMBLER
    ...
    for (node = _jitc->head; node; node = node->next)
    {
        ...
        {
        case jit_code_align:
            assert(!(node->u.w & (node->u.w - 1)) && node->u.w <= sizeof(jit_word_t));
            if (node->u.w == sizeof(jit_word_t) && (word = _jit->pc.w & (sizeof(jit_word_t) - 1)))
        ...
        case jit_code_movi:
            ...
            {
                temp = node->v.n;
                if (temp->code == jit_code_data || (temp->code == jit_code_label && (temp->flag & jit_flag_patch)))
        ...
        case jit_code_epilog:
            ...
            if (_jitc->again)
            {
                for (temp = undo.node->next; temp != node; temp = temp->next)
                {
                    if (temp->code == jit_code_label || temp->code == jit_code_epilog)
        ...
        case jit_code_finishr:
        case jit_code_finishi:
            break;
        default:
            abort();
        }
        ...
        if (_jitc->consts.length && (_jit->pc.uc - _jitc->consts.data >= 3968 ||
                                     (jit_uword_t)_jit->pc.uc - (jit_uword_t)_jitc->consts.patches[0] >= 3968))
        {
            /* longest sequence should be 64 bytes, but preventively
             * do not let it go past 128 remaining bytes before a flush */
            if (node->next && node->next->code != jit_code_jmpi && node->next->code != jit_code_jmpr &&
...
#undef case_rr
    ...
    for (offset = 0; offset < _jitc->patches.offset; offset++)
    {
        ...
        if (!jit_thumb_p() && (node->code == jit_code_movi || node->code == jit_code_calli))
        {
...
void jit_flush(void *fptr, void *tptr)
{
#if defined(__GNUC__)
    jit_uword_t i, f, t, s;
...
void _emit_ldxi(jit_state_t *_jit, jit_int32_t r0, jit_int32_t r1, jit_word_t i0)
{
    ldxi_i(rn(r0), rn(r1), i0);
}

void _emit_stxi(jit_state_t *_jit, jit_word_t i0, jit_int32_t r0, jit_int32_t r1)
{
    stxi_i(i0, rn(r0), rn(r1));
}

void _emit_ldxi_d(jit_state_t *_jit, jit_int32_t r0, jit_int32_t r1, jit_word_t i0)
{
    if (jit_swf_p())
...
void _emit_stxi_d(jit_state_t *_jit, jit_word_t i0, jit_int32_t r0, jit_int32_t r1)
{
    if (jit_swf_p())
...
static jit_int32_t _jit_get_reg_pair(jit_state_t *_jit)
{
...
static void _jit_unget_reg_pair(jit_state_t *_jit, jit_int32_t reg)
{
    jit_unget_reg(reg);
    switch (reg)
    {
 ...
 * code it is required */
static jit_bool_t _must_align_p(jit_state_t *_jit, jit_node_t *node)
{
...
static void _load_const(jit_state_t *_jit, jit_bool_t uniq, jit_int32_t r0, jit_word_t i0)
{
    jit_word_t w;
    jit_word_t d;
    jit_word_t base;
...
static void _flush_consts(jit_state_t *_jit)
{
    jit_word_t word;
    jit_int32_t offset;
    ...
    if (_jitc->data_info.ptr)
    {
        ...
        {
            jit_realloc((jit_pointer_t *)&_jitc->data_info.ptr, _jitc->data_info.length * sizeof(jit_data_info_t),
    ...
    for (offset = 0; offset < _jitc->consts.offset; offset += 2)
        patch_at(arm_patch_load, _jitc->consts.patches[offset], word + (_jitc->consts.patches[offset + 1] << 2));
    _jitc->consts.length = _jitc->consts.offset = 0;
}

/* to be called if needing to start over a function */
static void _invalidate_consts(jit_state_t *_jit)
{
    /* if no forward constants */
    if (_jitc->consts.length)
        _jitc->consts.length = _jitc->consts.offset = 0;
...
static void _patch(jit_state_t *_jit, jit_word_t instr, jit_node_t *node)
{
    jit_int32_t flag;
    jit_int32_t kind;
    ...
    {
        flag = node->u.n->flag;
        if (node->code == jit_code_calli || (node->code == jit_code_jmpi && !(node->flag & jit_flag_node)))
            kind = arm_patch_word;
        else
            kind = arm_patch_jump;
    }
    ...
    {
        jit_realloc((jit_pointer_t *)&_jitc->patches.ptr, _jitc->patches.length * sizeof(jit_patch_t),
