...
jit_node_t *_jit_arg(jit_state_t *_jit)
{
    ...
    node = jit_new_node_ww(jit_code_arg, offset, ++_jitc->function->self.argn);
    jit_link_prolog();
    return (node);
}
...
jit_node_t *_jit_arg_f(jit_state_t *_jit)
{
    ...
    node = jit_new_node_ww(jit_code_arg_f, offset, ++_jitc->function->self.argn);
    jit_link_prolog();
    return (node);
}
...
jit_node_t *_jit_arg_d(jit_state_t *_jit)
{
    ...
    node = jit_new_node_ww(jit_code_arg_d, offset, ++_jitc->function->self.argn);
    jit_link_prolog();
    return (node);
}
...
void _jit_getarg_ui(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_getarg_l(jit_state_t *_jit, jit_int32_t u, jit_node_t *v)
{
    assert(v->code == jit_code_arg);
...
void _jit_retval_ui(jit_state_t *_jit, jit_int32_t r0)
{
...
void _jit_retval_l(jit_state_t *_jit, jit_int32_t r0)
{
...
#define case_brf(name)                                                                                                 \
    case jit_code_##name##i_f:                                                                                         \
        ...
        {                                                                                                              \
            word = name##i_f(_jit->pc.w, rn(node->v.w), node->w.f);                                                    \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break
#define case_brd(name)                                                                                                 \
    case jit_code_##name##i_d:                                                                                         \
        ...
        {                                                                                                              \
            word = name##i_d(_jit->pc.w, rn(node->v.w), node->w.d);                                                    \
            patch(word, node);                                                                                         \
        }                                                                                                              \
        break
#if DEVEL_DISASSEMBLER
